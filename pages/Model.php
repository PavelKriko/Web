...
$model = $pdo->query('SELECT AboutModel,Name,Photo,BodyType,Transmision,Engine,Speed,Cost FROM Manufacturer inner join Car on Car.ManufacturerID = Manufacturer.ID where ManufacturerName ="'.$manufacturer.'" and Name="'.$model_name.'"')->fetchAll(PDO::FETCH_ASSOC);
